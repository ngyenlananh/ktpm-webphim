...
<html lang="vi">
   <head>
     ...
     <link rel='stylesheet' id='bootstrap-css' href='<?php echo e(asset('css/bootstrap.min.css')); ?>' media='all' /> 
  

    <link rel='stylesheet' id='style-css' href='<?php echo e(asset('css/style.css')); ?>' media='all' />
               ...
               <div class="collapse navbar-collapse" id="halim">
                  <div class="menu-menu_1-container">
                     <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                        <li class="current-menu-item active"><a title="Trang Chủ" href="<?php echo e(route('homepage')); ?>">Trang Chủ</a></li>
                        <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="mega"><a title="<?php echo e($cate->title); ?>" href="<?php echo e(route('category')); ?>"><?php echo e($cate->title); ?></a></li>
                        ...
                        <li class="mega dropdown">
                           ...
                           <ul role="menu" class=" dropdown-menu">
                               <?php $__currentLoopData = $genre; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $gen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <li><a title="<?php echo e($gen->title); ?>" href="<?php echo e(route('genre')); ?>"><?php echo e($gen->title); ?></a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <li class="mega dropdown">
                           ...
                           <ul role="menu" class=" dropdown-menu">
                              <?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <li><a title="<?php echo e($count->title); ?>" href="<?php echo e(route('country')); ?>"><?php echo e($count->title); ?></a></li>
                               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                           </ul>
                        </li>
...
</html><?php /**PATH D:\Laravel\webphim_tutorial\resources\views/layout.blade.php ENDPATH**/ ?>