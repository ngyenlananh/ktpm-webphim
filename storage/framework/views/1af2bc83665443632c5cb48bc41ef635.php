                  ...
                  <div id="halim-advanced-widget-4-ajax-box" class="halim_box">
                     <article class="col-md-2 col-sm-4 col-xs-6 thumb grid-item post-38424">
                        <div class="halim-item">
                           <a class="halim-thumb" href="<?php echo e(route('movie')); ?>" title="GÓA PHỤ ĐEN">
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laravel\webphim_tutorial\webphim_tutorial\resources\views/pages/home.blade.php ENDPATH**/ ?>